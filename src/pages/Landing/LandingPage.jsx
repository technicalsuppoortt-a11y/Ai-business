  ...
  return (
    <div className="landing-page" dir={state.language === "ar" ? "rtl" : "ltr"}>
        ...
        >
          <div className="lp-footer-brand-wrap" style={{ display: "flex", flexDirection: "column", gap: 10, alignItems: "flex-start" }}>
            ...
            <div style={{ display: "flex", gap: "16px", marginTop: "12px", alignItems: "center" }}>
              <a href={brandData?.socialLinks?.facebook || "https://facebook.com"} target="_blank" rel="noreferrer" style={{ color: "var(--text2)", transition: "color 0.2s", display: "flex", alignItems: "center" }} onMouseOver={(e) => e.currentTarget.style.color = "#1877F2"} onMouseOut={(e) => e.currentTarget.style.color = "var(--text2)"}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
              </a>
              <a href={brandData?.socialLinks?.instagram || "https://instagram.com"} target="_blank" rel="noreferrer" style={{ color: "var(--text2)", transition: "color 0.2s", display: "flex", alignItems: "center" }} onMouseOver={(e) => e.currentTarget.style.color = "#E1306C"} onMouseOut={(e) => e.currentTarget.style.color = "var(--text2)"}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href={brandData?.socialLinks?.twitter || "https://twitter.com"} target="_blank" rel="noreferrer" style={{ color: "var(--text2)", transition: "color 0.2s", display: "flex", alignItems: "center" }} onMouseOver={(e) => e.currentTarget.style.color = "#1DA1F2"} onMouseOut={(e) => e.currentTarget.style.color = "var(--text2)"}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg>
              </a>
              <a href={brandData?.socialLinks?.linkedin || "https://linkedin.com"} target="_blank" rel="noreferrer" style={{ color: "var(--text2)", transition: "color 0.2s", display: "flex", alignItems: "center" }} onMouseOver={(e) => e.currentTarget.style.color = "#0A66C2"} onMouseOut={(e) => e.currentTarget.style.color = "var(--text2)"}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
              </a>
              <a href={brandData?.socialLinks?.tiktok || "https://tiktok.com"} target="_blank" rel="noreferrer" style={{ color: "var(--text2)", transition: "color 0.2s", display: "flex", alignItems: "center" }} onMouseOver={(e) => e.currentTarget.style.color = "#00F2FE"} onMouseOut={(e) => e.currentTarget.style.color = "var(--text2)"}>
      ...
      <AnimatePresence>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="modal-content custom-scrollbar" style={{ background: "var(--bg1)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 24, width: "100%", maxWidth: 700, maxHeight: "85vh", overflowY: "auto", position: "relative", boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255,255,255,0.05)" }} onClick={(e) => e.stopPropagation()}>
              ...
              <div style={{ padding: "30px 40px", display: "flex", flexDirection: "column", gap: 30 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                  <div style={{ width: 50, height: 50, borderRadius: 16, background: "linear-gradient(135deg, rgba(59,130,246,0.15), rgba(147,51,234,0.15))", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 0 20px rgba(59,130,246,0.2)" }}>
        ...
        {showTerms && (
          <div className="modal-overlay" style={{ position: "fixed", inset: 0, backgroundColor: "rgba(0,0,0,0.4)", backdropFilter: "blur(12px)", zIndex: 999999, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }} onClick={() => setShowTerms(false)}>
            <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="modal-content custom-scrollbar" style={{ background: "var(--bg1)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 24, width: "100%", maxWidth: 700, maxHeight: "85vh", overflowY: "auto", position: "relative", boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.5), 0 0 0 1px rgba(255,255,255,0.05)" }} onClick={(e) => e.stopPropagation()}>
              <div style={{ position: "sticky", top: 0, background: "rgba(var(--bg1-rgb, 15, 23, 42), 0.95)", backdropFilter: "blur(10px)", padding: "24px 30px", borderBottom: "1px solid var(--border1)", display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: 10 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ width: 40, height: 40, borderRadius: 12, background: "linear-gradient(135deg, rgba(59,130,246,0.1), rgba(147,51,234,0.1))", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(255,255,255,0.05)" }}>
